...
path = 'C:/Users/crybelloceferin/Documents/MATLAB/Supun/E3Yesid'
os.chdir(path)
...
def writeCsv(csvVar,csvName):
    with open('C:/Users/crybelloceferin/Documents/MATLAB/Supun/E3Yesid/'+csvName+'.csv', 'w', newline='') as csv_file:
        csv_writer = csv.writer(csv_file,delimiter=';')
        csv_writer.writerows(csvVar)

def loadCsv(csvName):
    csv_list = []
    with open('C:/Users/crybelloceferin/Documents/MATLAB/Supun/E3Yesid/'+csvName+'.csv', 'r', newline='') as csv_file:
